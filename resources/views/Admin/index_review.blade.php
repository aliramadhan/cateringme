    ...
    @endif
     ...
     <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Report Catering') }} <span class="font-normal text-lg">{{ __('/ Review & Feed ') }}</span>
        </h2>
    </x-slot>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg Static h-full">
         ...
         <div class="relative h-full">
            ...
            <div class="bootstrapiso w-full bg-transparent text-base ">
                <div class="md:absolute text-2xl font-semibold top-9 md:text-left text-center"><span class="text-gray-500">Period : </span>  @if($from == null) All time @else {{$from->format('d F Y')}} - {{$to->format('d F Y')}} @endif </div>
            ...
            <tr>
                ...
                <th>Review</th>
                <th>Rate</th>
                <th data-visible="false">Order date</th>
                <th>Reviewed at</th>
        </tr>
