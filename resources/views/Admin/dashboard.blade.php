					...
					<div class="rounded-lg shadow-sm mb-4 h-44">
						...
						<div class="rounded-lg bg-white shadow-lg md:shadow-xl relative overflow-hidden hover:shadow-xl  animate transform transition-transform hover:-translate-y-2 duration-1000 h-full">
							<div class="px-3 pt-8 pb-10 text-center relative z-10">
								...
								@else ▼ @endif {{number_format($persen_catering_taken,2,",",".")}} %</p>
							</div>
					...
					<div class="rounded-lg shadow-sm mb-4 h-44">
						...
						<div class="rounded-lg bg-white shadow-lg md:shadow-xl relative overflow-hidden hover:shadow-xl  animate transform transition-transform hover:-translate-y-2 duration-1000 h-full">
							<div class="px-3 pt-8 pb-10 text-center relative z-10">
								...
								<p class="text-base animate-bounce @if($not_taken > $subnot_taken) text-green-500-500  @else text-red-500  @endif  leading-tight">@if($not_taken > $subnot_taken) ▲ @else ▼ @endif {{number_format($persen_not_taken,2,",",".")}}%</p>
							</div>
							<div class="absolute bottom-0 inset-x-0">
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner h-52 md:h-96 h-auto">
				...
				<div class="carousel-item @if($loop->iteration == 1) active @endif h-100">
					<img class="d-block w-100 h-96 rounded-xl object-cover " src="@if($menu->photos->first() != null ){{url('public/'.$menu->photos->first()->file)}}  @else {{url('public/images/no-image.png')}} @endif" alt="First slide">
