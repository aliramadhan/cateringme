     ...
     <div class="py-12">
      ...
      <div class="relative md:h-screen h-full">
        <div class=" inset-0 w-full h-full  text-gray-600 flex text-5xl p-6 transition-all ease-in-out duration-1000 transform translate-x-0 slide text-base overflow-y-auto bg-gray-100" >      
          ...
          <div class="grid grid-flow-row md:grid-cols-4 grid-cols-2 gap-4  items-center text-center mt-5 h-max mx-auto w-full"   style="height: fit-content;">      
                        ...
                        <div class="rounded-lg bg-white shadow-lg md:shadow-xl relative overflow-hidden transform hover:-translate-y-2 hover:shadow-2xl duration-500 cursor-pointer">
                            ...
                            <div class="flex flex-row text-base bg-white py-2 z-10 bottom-0 absolute rounded-br-xl text-gray-600 px-4 hover:bg-gray-900 hover:text-white duration-500 cursor-pointer flex items-center">
                                     ...
                                     <div class="ml-2 text-left">
                                        <a href="#" class=" font-semibold truncate">{{$order->employee->name}}</a>
